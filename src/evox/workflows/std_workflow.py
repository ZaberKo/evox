...
class StdWorkflow(Workflow):
    ...
    def __init__(
        ...
        external_problem
            ...
            Default to True.
        num_objectives
            Number of objectives. Used when external_problem=False.
        ...
        if self.external_problem is False and self.num_objectives is None:
            raise ValueError(
    ...
    def enable_multi_devices(self, state: State, pmap_axis_name=POP_AXIS_NAME) -> State:
        ...
        """
        if self.external_problem is False:
            raise ValueError(
